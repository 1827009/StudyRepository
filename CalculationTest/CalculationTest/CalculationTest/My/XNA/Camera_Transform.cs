...
namespace MyXNA
{
    class Camera_Transform : My.BoneTransform
    {
        My.BoneTransform flontObj;

        public Camera_Transform(My.BoneTransform parent) : base(parent)
        {
            flontObj = new My.BoneTransform(this);
            flontObj.LocalPosition = new My.Vector3(0, 0, -1);
        ...
        My.BoneTransform target;
        public My.BoneTransform Target
        {
            get { return target; }
            set
            {
